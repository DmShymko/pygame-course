...
#Create images...returns a Surface object eith the image drawon on it.
#We can then get the rect of the surface and use the rect to position the image.
dragon_left_image = pygame.image.load("resources/images/dragon_left.png")
dragon_left_rect = dragon_left_image.get_rect()
dragon_left_rect.topleft = (0,0)

dragon_right_image = pygame.image.load("resources/images/dragon_right.png")
